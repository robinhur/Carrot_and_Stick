...
namespace Carrot_and_Stick_PC
{
    ...
    public partial class Carrot1 : Form
    {
        ...
        private void Carot1_Load(object sender, EventArgs e)
        {
            ...
            webBrowser1.Url = new System.Uri("https://carotandstick-35d0e.firebaseapp.com/");
            webBrowser1.ObjectForScripting = this;
        }
        private void Carot1_FormClosing(object sender, FormClosingEventArgs e)
        {
            //EnableCTRLALTDEL();
            ShowStartMenu();
        ...
        {
            webBrowser1.Document.InvokeScript("logout_user");
        ...
        public void getUserInfo(object email, object name, object credit)
        {
            textBox1.Text = email.ToString();
            textBox2.Text = name.ToString();
            textBox3.Text = credit.ToString();
